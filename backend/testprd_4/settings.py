"""
Django settings for testprd_4 project.
...
WSGI_APPLICATION = 'testprd_4.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testprd_4 API",
    "DESCRIPTION": "API documentation for testprd_4 App",
    "VERSION": "v1",
}
